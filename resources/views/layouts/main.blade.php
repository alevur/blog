    ...
    <div class="container">
        <div class="footer-banner" data-aos="fade-up">
            ...
            <div class="banner-btns-wrapper">
                <button class="btn btn-success"> <img src="{{asset('/images/apple@1x.svg')}}" alt="ios" class="mr-2"> App Store</button>
                <button class="btn btn-success"> <img src="{{asset('/images/android@1x.svg')}}" alt="android" class="mr-2"> Google Play</button>
            </div>
